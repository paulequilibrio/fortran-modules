...
contains
  ...
  subroutine test_file_already_exist
    ...
    already_exist = file_already_exist('../data/input_test.csv')
  ...
  subroutine test_file_is_readable
    ...
    logical :: is_readable
    is_readable = file_is_readable('../data/input_test.csv')
  ...
  subroutine test_file_is_writable
    ...
    logical :: is_writable
    is_writable = file_is_writable('../data/input_test.csv')
